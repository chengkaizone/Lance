...
import org.lance.interpolator.BounceInterpolator;
import org.lance.interpolator.CircInterpolator;
import org.lance.interpolator.CubicInterpolator;
import org.lance.interpolator.EasingType;
import org.lance.interpolator.ElasticInterpolator;
import org.lance.interpolator.ExpoInterpolator;
import org.lance.interpolator.QuadInterpolator;
import org.lance.interpolator.QuartInterpolator;
import org.lance.interpolator.QuintInterpolator;
import org.lance.interpolator.SineInterpolator;
import org.lance.main.R;
import org.lance.widget.PlotView;

public class InterpolatorsDemo extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.interpolators_main);
		...
		easing.setOnItemSelectedListener(new OnItemSelectedListener() {
			public void onItemSelected(AdapterView<?> parent, View view,
				...
				case 2:
					...
					break;
				case 3:
					interpolator = new ElasticInterpolator(EasingType.IN, 1,
							0.3f);
					break;
				case 4:
					interpolator = new ElasticInterpolator(EasingType.OUT, 1,
							0.3f);
					break;
				case 5:
					interpolator = new ElasticInterpolator(EasingType.INOUT, 1,
							0.3f);
					break;
				case 6:
				...
				for (float t = 0; t <= 1; t += 0.01f) {
					...
					// Log.d("TestInterpolators", "interpolation " +
					// interpolation);
