...
public class DefaultRenderer implements Serializable {
	...
	/** A no color constant. */
	public static final int NO_COLOR = Color.BLACK;
	/** The default background color. */
	public static final int BACKGROUND_COLOR = Color.BLACK;// 默认背景颜色黑色
	...
	private static final Typeface REGULAR_TEXT_FONT = Typeface.create(
			Typeface.SERIF, Typeface.NORMAL);// 指定固定的字体
	...
	/** The axes color. */
	private int mAxesColor = TEXT_COLOR;// 默认轴的颜色
	/** If the labels are visible. */
	private boolean mShowLabels = true;
	/** The labels color. */
	private int mLabelsColor = TEXT_COLOR;// 默认标签字的颜色
	 ...
	 * shrink when not enough space. 如果图表是在一个滚动且不需要收缩当没有足够的空间
	 */
	private boolean mInScroll;
	/** The start angle for circular charts such as pie, doughnut, etc. */
	private float mStartAngle = 0;// 圆形图表如派,甜甜圈的开始角度
	...
	/**
	 * Returns the chart title. 返回图表标题
	 * 
	...
	/**
	 * Returns the chart title text size. 返回图表标题的字体大小
	 * 
	...
	/**
	 * Sets the chart title text size. 设置图表标题字体大小
	 * 
	 * @param textSize
	 *            the chart title text size
	 */
	...
	/**
	 * Adds a simple renderer to the multiple renderer. 添加一个简单(单个)渲染器到多组合渲染器
	 * 
	 * @param renderer
	...
	/**
	 * Removes a simple renderer from the multiple renderer. 从多渲染组合中移除一个渲染器
	 * 
	 * @param renderer
	...
	/**
	 * Removes all renderers from the multiple renderer. 移除所有的渲染器
	 */
	...
	/**
	 * Returns the background color. 返回渲染器背景色
	 * 
	...
	/**
	 * Returns if the background color should be applied. 返回是否使用背景色
	 * 
	...
	/**
	 * Sets if the background color should be applied. 设置是否使用背景色
	 * 
	 * @param apply
	...
	/**
	 * Returns the labels color. 返回标签颜色
	 * 
	...
	/**
	 * Returns the labels text size. 返回标签字体大小
	 * 
	...
	/**
	 * Sets the labels text size. 设置标签字体大小
	 * 
	 * @param textSize
	 *            the labels text size
	 */
	...
	/**
	 * Returns if the axes should be visible. 返回轴是否可见
	 * 
	...
	/**
	 * Sets if the axes should be visible. 设置轴是否可见
	 * 
	 * @param showAxes
	...
	/**
	 * Returns if the labels should be visible. 返回标签是否可见
	 * 
	...
	/**
	 * Sets if the labels should be visible. 设置轴是否可见
	 * 
	 * @param showLabels
	...
	/**
	 * Returns if the X axis grid should be visible. 返回X轴的网格是否可见
	 * 
	...
	/**
	 * Returns if the Y axis grid should be visible. 返回Y轴的网格是否可见
	 * 
	...
	/**
	 * Sets if the X axis grid should be visible. 设置X轴的网格是否可见
	 * 
	 * @param showGrid
	...
	/**
	 * Sets if the Y axis grid should be visible. 设置Y轴网格是否可见
	 * 
	 * @param showGrid
	...
	/**
	 * Sets if the grid should be visible. 设置网格是否可见
	 * 
	 * @param showGrid
	...
	/**
	 * Returns if the legend should be visible. 返回刻纹是否可见
	 * 
	...
	/**
	 * Sets if the legend should be visible. 设置刻纹是否可见
	 * 
	 * @param showLegend
	...
	/**
	 * Sets the visible state of the zoom buttons. 设置图标缩放按钮可见状态
	 * 
	 * @param visible
	...
	/**
	 * Returns the enabled state of the click. 返回点击可用状态
	 * 
	...
	/**
	 * Sets the enabled state of the click. 设置点击可用状态
	 * 
	 * @param enabled
	 *            click enabled
	 */
	...
	/**
	 * Sets the selectable radius value around clickable points. 设置选择半径值内可点击的点
	 * 
	 * @param buffer
	...
	/**
	 * Returns the legend height. 返回刻纹的高度
	 * 
	...
	/**
	 * Sets the legend height, in pixels. 设置刻纹高度
	 * 
	 * @param height
	 *            the legend height
	 */
	 ...
	 * top, left, bottom, right 返回外边距数组---一个包含边距值得数组
	 * 
	...
	/**
	 * Sets the margins, in pixels. 设置边距数组
	 * 
	 * @param margins
	 ...
	 * when not enough space. 设置图表在滚动视图内是否允许缩放,当没有足够空间时
	 * 
	 * @param inScroll
	 ...
	 * o'clock on a watch.) 返回开始角度 圆环图表(饼图,甜甜圈) 0-360度
	 * 
	 ...
	 * angle of 0 degrees correspond to the geometric angle of 0 degrees (3
	 * o'clock on a watch.) 设置开始角度 0-360度
	 * 
	 * @param startAngle
	...
	/**
	 * Returns if the values should be displayed as text. 返回是否显示文本值
	 * 
	 ...
	 * @param colors
	 */
	public void setRendererColor(int[] colors) {
		for (int i = 0; i < colors.length; i++) {
			SimpleSeriesRenderer r = mRenderers.get(i);
			r.setColor(colors[i]);
		}
	}
}
