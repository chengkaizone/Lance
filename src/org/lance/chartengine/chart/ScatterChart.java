...
/**
 * The scatter chart rendering class. 散射图表
 * 
 * @author lance
 * 
 */
public class ScatterChart extends XYChart {
	...
	/**
	 * Builds a new scatter chart instance. 创建散射图表实例
	 * 
	 * @param dataset
	...
	/**
	 * The graphical representation of an X point shape. 绘制一个X形状的点图形
	 * 
	 * @param canvas
	 *            the canvas to paint to
	 * @param paint
	...
	/**
	 * The graphical representation of a circle point shape. 绘制圆点图形
	 * 
	 * @param canvas
	 *            the canvas to paint to
	 * @param paint
	...
	/**
	 * The graphical representation of a triangle point shape. 绘制三角形
	 * 
	 * @param canvas
	 *            the canvas to paint to
	 * @param paint
	...
	/**
	 * The graphical representation of a square point shape. 绘制一个矩形区域
	 * 
	 * @param canvas
	 *            the canvas to paint to
	 * @param paint
	...
	/**
	 * The graphical representation of a diamond point shape. 绘制钻石点图表
	 * 
	 * @param canvas
	 *            the canvas to paint to
	 * @param paint
	...
	/**
	 * Returns the chart type identifier. 返回类型
	 * 
