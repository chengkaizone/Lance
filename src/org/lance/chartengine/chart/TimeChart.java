...
/**
 * The time chart rendering class. 时间图表
 * 
 * @author lance
 * 
 */
public class TimeChart extends LineChart {
	...
	/**
	 * Builds a new time chart instance. 创建图表实例
	 * 
	 * @param dataset
	...
	/**
	 * The graphical representation of the labels on the X axis. 绘制X轴标签
	 * 
	 * @param xLabels
	 *            the X labels values
	...
	/**
	 * Returns the chart type identifier. 返回类型标志符
	 * 
