...
/**
 * The bar chart rendering class 绘制柱状体图表
 * 
 * @author lance
 * 
 */
public class BarChart extends XYChart {
	...
	/**
	 * Builds a new bar chart instance. 创建一个柱状图形实例
	 * 
	 * @param dataset
	...
	/**
	 * The graphical representation of a series. 绘制序列表示的图形
	 * 
	 * @param canvas
	...
	/**
	 * The graphical representation of the series values as text. 绘制图表中序列的文本值
	 * 
	 * @param canvas
	 *            the canvas to paint to
	 * @param series
	...
	/**
	 * The graphical representation of the legend shape. 刻纹代表图形
	 * 
	 * @param canvas
	 *            the canvas to paint to
	 * @param renderer
	 ...
	 * of 2 consecutive points. 计算并返回图表中连续两个点的中间值
	 * 
	 * @param points
	 *            the points
	 * @param length
	...
	/**
	 * Returns if the chart should display the null values. 如果渲染器是null,返回true
	 * 
	...
	/**
	 * Returns the default axis minimum. 返回默认轴的最小值
	 * 
