...
import org.lance.chartengine.renderer.BasicStroke;
...
/**
 * The XY chart rendering class. XY垂直坐标系图表
 * 
 * @author lance
 * 
 */
public abstract class XYChart extends AbstractChart {
	 ...
	 * and the RectF list index is the point index in that series. 保存所有点可点击的曲剧.
	 * 数组索引是一个序列索引, 且矩形列表索引是在这个序列的索引.
	 */
	...
	/**
	 * Builds a new XY chart instance. 创建X,Y图表实例
	 * 
	 * @param dataset
	 *            the multiple series dataset
	 * @param renderer
	...
	/**
	 * The graphical representation of the XY chart. 绘制坐标图表
	 * 
	 * @param canvas
	...
	public void draw(Canvas canvas, int x, int y, int width, int height,
		...
		mCenter = new ChartPoint((x + width) / 2, (y + height) / 2);
		if (rotate) {
	...
	/**
	 * The graphical representation of the series values as text. 图形表示的系列值为文本。
	 * 
	 * @param canvas
	 *            the canvas to paint to
	 * @param series
	...
	/**
	 * The graphical representation of the series values as text. 绘制文本,
	 * 同时处理水平和垂直方向和额外的旋转角度.
	 * 
	 * @param canvas
	 *            the canvas to paint to
	 ...
	 * orientations. 转换画布 让它可以处理水平和垂直方向
	 * 
	 * @param canvas
	 *            the canvas to paint to
	 * @param angle
	...
	/**
	 * The graphical representation of the labels on the X axis. 绘制X轴上的文本标签
	 * 
	 * @param xLabels
	 *            the X labels values
	...
	/**
	 * The graphical representation of the labels on the X axis. 绘制Y轴上的标签
	 * 
	 * @param allYLabels
	 *            the Y labels values
	 * @param canvas
	...
	/**
	 * Transforms a screen point to a real coordinates point. 转换屏幕点到真实的坐标点
	 * 
	 * @param screenX
	...
	/**
	 * The graphical representation of a series. 绘制图表数据
	 * 
	 * @param canvas
	 *            the canvas to paint to
	 * @param paint
	...
	/**
	 * Returns the clickable areas for all passed points 根据所有通过的点返回可点击的区域
	 * 
	 * @param points
	 *            the array of points
	 * @param values
	...
	/**
	 * Returns if the chart should display the null values. 是否渲染null值
	 * 
	...
	/**
	 * Returns the default axis minimum. 获取默认轴的最小值
	 * 
