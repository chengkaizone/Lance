...
import org.lance.chartengine.util.IndexXYMap;
import org.lance.chartengine.util.MathHelper;
import org.lance.chartengine.util.XYEntry;

/**
 * 一个X,Y系列的封装X,Y图表类,如线,时间,区域,分散...
 * 
 * @author lance
 * 
 */
public class XYSeries implements Serializable {
	...
	/**
	 * Builds a new XY series. 创建一个坐标系列
	 * 
	 * @param title
	 *            the series title.
	 */
	...
	/**
	 * Builds a new XY series. 创建一个坐标系列---带缩放比
	 * 
	 * @param title
	 *            the series title.
	 * @param scaleNumber
	...
	/**
	 * Initializes the range for both axes. 初始化X,Y轴的范围
	 */
	...
	/**
	 * Updates the range on both axes. 更新X,Y轴的范围
	 * 
	 * @param x
	 *            the new x value
	 * @param y
	...
	/**
	 * Removes an existing value from the series. 移除指定索引的系列
	 * 
	 * @param index
	...
	/**
	 * Removes all the existing values from the series. 移除所有坐标系列
	 */
	...
	/**
	 * Returns the X axis value at the specified index. 返回指定索引的X轴值
	 * 
	 * @param index
	 *            the index
	 * @return the X value
	...
	/**
	 * Returns the Y axis value at the specified index. 返回指定索引的Y轴值
	 * 
	 * @param index
	 *            the index
	 * @return the Y value
	...
	public synchronized SortedMap<Double, Double> getRange(double start,
			double stop, int beforeAfterPoints) {
	...
	/**
	 * Returns the minimum value on the X axis. 犯罪X轴的最小值
	 * 
	...
	/**
	 * Returns the minimum value on the Y axis. 返回Y轴的最小值
	 * 
	...
	/**
	 * Returns the maximum value on the X axis. 返回X轴的最大值
	 * 
	...
	/**
	 * Returns the maximum value on the Y axis. 返回Y轴的最大值
	 * 
