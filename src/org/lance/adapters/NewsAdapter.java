...
public class NewsAdapter extends BaseAdapter {
	...
	public NewsAdapter(Context context, List<String> descs, List<String> details) {
		...
		demo = BitmapFactory.decodeResource(context.getResources(),
				R.drawable.bg2);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.image = (ImageView) convertView
					.findViewById(R.id.adapter_news_img);
			holder.desc = (TextView) convertView
					.findViewById(R.id.adapter_news_desc);
			holder.detail = (TextView) convertView
					.findViewById(R.id.adapter_news_detail);
			holder.comment = (TextView) convertView
					.findViewById(R.id.adapter_news_comment);
