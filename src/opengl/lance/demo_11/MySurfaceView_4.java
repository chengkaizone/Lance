...
public class MySurfaceView_4 extends GLSurfaceView {
	...
	private class SceneRenderer implements GLSurfaceView.Renderer {
		...
		Floor rfloor;// 半透明反射面，用来 绘制比较真实的效果
		Floor floor;// 普通反射面
		Ball ball;// 用于绘制的球
		BallController ctrl;// 用于控制的球
		...
		public void onDrawFrame(GL10 gl) {
			...
			ctrl.drawSelfMirror(gl);// 绘制镜像体

			rfloor.drawSelf(gl);// 半透明地板
			ctrl.drawSelf(gl);// 绘制实际物体
		}
		...
		public void onSurfaceCreated(GL10 gl, EGLConfig config) {
			...
			// 创建半透明篮球 板
			rfloor = new Floor(4, 2.568f, lqcTMTexId);// 用来 绘制比较真实的效果
			// 初始化纹理
