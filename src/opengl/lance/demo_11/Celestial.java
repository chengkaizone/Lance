...
public class Celestial {
	...
	final float UNIT_SIZE = Constant_1.UNIT_SIZE * Constant_1.DESERT_COLS;// 天球半径
	...
	public Celestial(float xOffset, float zOffset, float scale, float yAngle,
			int vCount) {
	...
	public void drawSelf(GL10 gl) {
		...
		gl.glTranslatef(xOffset, 0, 0);// x向偏移
		gl.glTranslatef(0, 0, zOffset);// y向偏移
