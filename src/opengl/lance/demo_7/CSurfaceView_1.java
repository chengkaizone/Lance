...
public class CSurfaceView_1 extends GLSurfaceView {
	...
	public CSurfaceView_1(Context context) {
		super(context);
	...
	private class SceneRenderer implements GLSurfaceView.Renderer {
		...
		public void onSurfaceCreated(GL10 gl, EGLConfig config) {
			...
			int texId = initTexture(gl, R.drawable.stone);
			cylinder = new Cylinder_1(10, 2, 18, texId);
		}
