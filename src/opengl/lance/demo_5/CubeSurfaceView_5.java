...
public class CubeSurfaceView_5 extends GLSurfaceView {
	...
	public CubeSurfaceView_5(Context context) {
		super(context);
	...
	private class SceneRenderer implements GLSurfaceView.Renderer {
		...
		public void onSurfaceCreated(GL10 gl, EGLConfig config) {
			...
			initLight(gl);
			initMaterial(gl);
			cube = new OtherCubeVertex_5(2.5f, 2.5f, 2.5f);
			new Thread() {
				public void run() {
					while (true) {
						try {
