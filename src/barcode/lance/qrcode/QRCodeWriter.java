...
import barcode.lance.qrcode.encoder.ByteMatrix;
import barcode.lance.qrcode.encoder.QREncoder;
import barcode.lance.qrcode.encoder.QRCode;
...
public final class QRCodeWriter implements Writer {
	...
	public BitMatrix encode(String contents, BarcodeFormat format, int width,
		...
		QREncoder.encode(contents, errorCorrectionLevel, hints, code);
