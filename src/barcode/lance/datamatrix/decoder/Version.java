...
public final class Version {
	...
	private Version(int versionNumber, int symbolSizeRows,
	...
	public static Version getVersionForDimensions(int numRows, int numColumns)
		...
		// (bbrown): This is doing a linear search through the array of
		// versions.
		// If we interleave the rectangular versions with the square versions we
		// could
		// do a binary search.
	...
	private static Version[] buildVersions() {
		return new Version[] {
				...
				new Version(12, 40, 40, 18, 18, new ECBlocks(48,
						new ECB(1, 114))),
				new Version(13, 44, 44, 20, 20, new ECBlocks(56,
						new ECB(1, 144))),
				new Version(14, 48, 48, 22, 22, new ECBlocks(68,
						new ECB(1, 174))),
				new Version(15, 52, 52, 24, 24, new ECBlocks(42,
						new ECB(2, 102))),
				new Version(16, 64, 64, 14, 14, new ECBlocks(56,
						new ECB(2, 140))),
				new Version(17, 72, 72, 16, 16,
						new ECBlocks(36, new ECB(4, 92))),
				new Version(18, 80, 80, 18, 18, new ECBlocks(48,
						new ECB(4, 114))),
				new Version(19, 88, 88, 20, 20, new ECBlocks(56,
						new ECB(4, 144))),
				new Version(20, 96, 96, 22, 22, new ECBlocks(68,
						new ECB(4, 174))),
				new Version(21, 104, 104, 24, 24, new ECBlocks(56, new ECB(6,
						136))),
				new Version(22, 120, 120, 18, 18, new ECBlocks(68, new ECB(6,
						175))),
				new Version(23, 132, 132, 20, 20, new ECBlocks(62, new ECB(8,
						163))),
				new Version(24, 144, 144, 22, 22, new ECBlocks(62, new ECB(8,
						156), new ECB(2, 155))),
