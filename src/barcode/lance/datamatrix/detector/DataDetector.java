package barcode.lance.datamatrix.detector;
...
import barcode.lance.common.Collections;
import barcode.lance.common.Comparator;
 ...
 * @author Sean Owen
 */
public final class DataDetector {
	...
	public DataDetector(BitMatrix image) throws NotFoundException {
		this.image = image;
	...
	public DetectorResult detect() throws NotFoundException {
		...
		if (dimensionTop >= dimensionRight * 2
				|| dimensionRight >= dimensionTop * 2) {
