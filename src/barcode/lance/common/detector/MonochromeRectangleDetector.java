package barcode.lance.common.detector;
...
public final class MonochromeRectangleDetector {
	...
	public ResultPoint[] detect() throws NotFoundException {
		...
		ResultPoint pointB = findCornerFromCenter(halfWidth, -deltaX, left,
				right, halfHeight, 0, top, bottom, halfHeight >> 1);
	 ...
	 *            within the barcode
	 * @return a {@link barcode.lance.assist.google.zxing.ResultPoint}
	 *         encapsulating the corner that was found
	 * @throws NotFoundException
