...
public final class DefaultGridSampler extends GridSampler {
	...
	public BitMatrix sampleGrid(BitMatrix image, int dimensionX,
		...
		PerspectiveTransform transform = PerspectiveTransform
				.quadrilateralToQuadrilateral(p1ToX, p1ToY, p2ToX, p2ToY,
	...
	public BitMatrix sampleGrid(BitMatrix image, int dimensionX,
		...
		for (int y = 0; y < dimensionY; y++) {
			...
			try {
				...
				// misidentified, the resulting
				// transform gets "twisted" such that it maps a straight line of
				// points to a set of points
				// whose endpoints are in bounds, but others are not. There is
				// probably some mathematical
				// way to detect this about the transformation that I don't know
				// yet.
				// This results in an ugly runtime exception despite our clever
				// checks above -- can't have
				// that. We could check each point's coordinates but that feels
				// duplicative. We settle for
