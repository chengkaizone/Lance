package barcode.lance.client.camera;
...
public final class CameraManager {
	...
	public void openDriver(SurfaceHolder holder) throws IOException {
		...
		if (prefs.getBoolean(BarcodePreferences.FRONT_LIGHT, false)) {
	...
	public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
		...
		SharedPreferences sharedPrefs = PreferenceManager
				.getDefaultSharedPreferences(context);
		boolean reverseHorizontal = sharedPrefs.getBoolean(
				BarcodePreferences.REVERSE_IMAGE, false);
		...
		case PixelFormat.YCbCr_422_SP:
			return new PlanarYUVLuminanceSource(data, width, height, rect.left,
					rect.top, rect.width(), rect.height(), reverseHorizontal);
		default:
